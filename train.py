...
def parse_opt(known=False):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/traffic6519.yaml", help="dataset.yaml path")
    ...
    parser.add_argument("--project", default=ROOT / "runs6519/train", help="save to project/name")
